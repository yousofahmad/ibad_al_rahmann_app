...
class _StatsScreenState extends State<StatsScreen> {
    ...
    return Scaffold(
      ...
      body: _isLoading
          ? ListView.builder(
              ...
              itemCount: 4,
              itemBuilder: (_, __) => AppSkeleton.card(height: 150.h),
            )
            ...
            Positioned.fill(
              child: Align(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(color: goldColor.withValues(alpha: 0.1)),
                ),
              ),
            ),
            Padding(
  ...
  Widget _buildDayCard(
    ...
    double totalProgress = ((data['total'] ?? 0) as num).toDouble() / 100.0;
            ...
            Positioned.fill(
              child: Align(
                ...
                child: FractionallySizedBox(
                  ...
                  child: Container(color: goldColor.withValues(alpha: 0.08)),
                ),
              ),
            ),

            // Day number badge (adjusted for Stack/ClipRRect)
            // Note: Since we use ClipRRect, we can't easily have a negative positioned element
            // that overflows outside. We'll move it inside slightly or use a different approach.
            Padding(
